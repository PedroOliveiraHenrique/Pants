...
namespace NetPants.Areas.Admin.Controllers
{
    ...
    public class AdminRoupasController : Controller
    {
        ...
        {
            var resultado = _context.Roupas.Include(l => l.Categoria).AsQueryable();
        ...
        public async Task<IActionResult> Create([Bind("RoupaId,Nome,Marca,DescricaoCurta,DescricaoDetalhada,Preco,ImagemUrl,ImagemThumbnailUrl,IsRoupaPromocao,EmEstoque,CategoriaId")] Roupa roupa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RoupaId,Nome,Marca,DescricaoCurta,DescricaoDetalhada,Preco,ImagemUrl,ImagemThumbnailUrl,IsRoupaPromocao,EmEstoque,CategoriaId")] Roupa roupa)
        {
            if (id != roupa.RoupaId)
            {
                return NotFound();
